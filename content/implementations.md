...
|[Toil](https://github.com/BD2KGenomics/toil)|Toil is a workflow engine entirely written in Python.|[CWL v1.0 - v1.2 ![Required](https://badgen.net/https/ucsc-ci.com/api/v4/projects/3/jobs/artifacts/master/raw/badges1.2/required.json%3Fjob=cwl_badge%26search_recent_successful_pipelines=true?icon=commonwl)](https://toil.readthedocs.io/en/latest/cwl/conformance.html#)<br />(and [**all** optional features](https://toil.readthedocs.io/en/latest/cwl/conformance.html#cwl-1-2-optional-features))|AWS, GCP, Grid Engine, HTCondor, LSF, Slurm, PBS/Torque|
