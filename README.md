...
[common-workflow-language+subscribe@googlegroups.com](mailto:common-workflow-language+subscribe@googlegroups.com)
...
|[REANA](https://docs.reana.io/)|RE usable ANAlyses|Kubernetes, [CERN OpenStack](https://clouddocs.web.cern.ch/clouddocs/containers/) ([OpenStack Magnum](https://wiki.openstack.org/wiki/Magnum))|
...
|[cwl-utils](https://github.com/common-workflow-language/cwl-utils)|Example scripts using the new Python 3.6+ CWL parsing library, includes a script to [cache all software containers](https://github.com/common-workflow-language/cwl-utils#pull-the-all-referenced-software-container-images) for a given CWL document.|
...
but you can also contact the CWL leadership team & Conservancy directly via [commonworkflowlanguage@sfconservancy.org](mailto:commonworkflowlanguage@sfconservancy.org).
